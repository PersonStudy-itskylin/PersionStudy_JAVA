...
import com.hglq4.shopping.model.Cart;
import com.hglq4.shopping.model.CartItem;
...
import com.hglq4.shopping.model.dto.OrderFormDto;
...
import com.hglq4.shopping.util.ordercode.BlueSkySerialNumber;
import com.hglq4.shopping.util.ordercode.FileEveryDaySerialNumber;

/**
 * 完成http://localhost/shopping/index.do这个请求
...
public class IndexController {
	...
	public ModelAndView buyUpdate(HttpServletRequest request,CartItem itemdto,HttpSession session) throws UnsupportedEncodingException {
		...
		BlueSkySerialNumber serial = (BlueSkySerialNumber)session.getAttribute("serial");
		if(serial == null){
