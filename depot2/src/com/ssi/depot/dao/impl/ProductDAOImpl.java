...
public class ProductDAOImpl extends SqlSessionDaoSupport implements IProductDAO {
	...
	public int insertProduct(Product product) {
		return getSqlSession().insert(NAMESPACE + "insertProduct", product);
	}
	...
	public int delProduct(String proid) {
		return getSqlSession().delete(NAMESPACE + "delProduct", Integer.valueOf(proid));
	}
	...
	public int updateProduct(Product product) {
		return getSqlSession().update(NAMESPACE + "updateProduct", product);
	}
	...
	public Product selectProductById(String id) {
		return (Product) getSqlSession().selectOne(NAMESPACE + "selectProductById", Integer.valueOf(id));
	}
	...
	public List<Product> selectProductAll() {
		return getSqlSession().selectList(NAMESPACE + "selectProductAll");
	}
	...
	public List<Product> selectProductByPage(Map<String, Integer> map) {
		 return getSqlSession().selectList(NAMESPACE + "selectProductByPage", map);
	}

	/**
	 * 
	 * 功能描述： 判断新增的产品在仓库中是否存在
	 */
	@Override
	public Product selectProductByIfProduct(Product product) {
		return (Product) getSqlSession().selectOne(NAMESPACE + "selectProductByIfProduct", product);
	}
