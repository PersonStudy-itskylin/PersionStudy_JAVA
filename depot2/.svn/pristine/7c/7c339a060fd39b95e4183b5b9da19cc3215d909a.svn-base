...
public interface IProductService {
	...
	Map<String, Object> findProductById(String id);
	
	Map<String, Object> addProduct(Product product); 
	
	Map<String, Object> findProductAll();
	
	Map<String, Object> findProductPage(Integer page,Integer start,Integer pageSize);
	
	Map<String, Object> updateProduct(Product product);
	
	Map<String, Object> deleteProductById(String id);
