...
public class BackupDAOImpl extends SqlSessionDaoSupport implements IBackupDAO{
	...
	public Backup selectBackupById(String id) {
		return (Backup) getSqlSession().selectOne(NAMESPACE + "selectBackupById", id);
	}
	...
	public List<Backup> selectBackupAll() {
		return getSqlSession().selectList(NAMESPACE + "selectBackupAll");
	}
	...
	public List<Backup> selectBackupByPage(Map<String ,Integer> map) {
		return getSqlSession().selectList(NAMESPACE + "selectBackupByPage",map);
	}
	...
	public int updateBackupById(Backup backup) {
		return getSqlSession().update(NAMESPACE + "updateBackupById",backup);
	}
	...
	public int deleteBackupById(String id) {
		return getSqlSession().delete(NAMESPACE + "deleteBackupById", id);
	}

	@Override
	public int insertBackup(Backup backup) {
		return getSqlSession().delete(NAMESPACE + "insertBackup", backup);
