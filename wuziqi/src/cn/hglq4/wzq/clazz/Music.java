...
/**
 * @see Music play/pause
 * @version build20140428
 * @author Blue_Sky
 *
 */
public class Music {
	...
	public static Music getMusic() {
		Bflag = 0;
		Wflag = 0;
		BGurl = Music.class.getClassLoader().getResource("cn.hglq4.wzq.audio/BGmusic.wav");
		// System.out.println(BGurl);
		Burl = Music.class.getClassLoader().getResource("cn.hglq4.wzq.audio/Bmusic.wav");
		// System.out.println(Burl);
		Wurl = Music.class.getClassLoader().getResource("cn.hglq4.wzq.audio/Wmusic.wav");
		// System.out.println(Wurl);
		Winurl = Music.class.getClassLoader().getResource("cn.hglq4.wzq.audio/Winmusic.wav");
		return music;
	}
