...
//	private Account account;//操作用户
	 ...
	 * @param sysremark
	 */
	public SystemLog(Integer sysid, String sysname,
	...
	public String toString() {
		return "SystemLog [sysid=" + sysid + ", account=" /*+ account.getRealname()*/
...
/*	public Account getAccount() {
	...
	*//**
	...
	/**
	 * @param sysremark 要设置的 sysremark
	 */
