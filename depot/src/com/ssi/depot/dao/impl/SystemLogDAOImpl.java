...
public class SystemLogDAOImpl extends SqlSessionDaoSupport implements ISystemLogDAO {
	...
	public int insertSystemLog(SystemLog sys) {
		return getSqlSession().insert("com.ssi.depot.dao.ISystemLogDAO.insertSystemLog", sys);
	}
	...
	public int deleteSystemLog(String sysid) {
		return getSqlSession().delete("com.ssi.depot.dao.ISystemLogDAO.deleteSystemLog", Integer.valueOf(sysid));
	}
	...
	public int updateSystemLog(SystemLog sys) {
		return getSqlSession().update("com.ssi.depot.dao.ISystemLogDAO.updateSystemLog", sys);
	}
	...
	public List<SystemLog> selectSystemLogByAll() {
		return getSqlSession().selectList("com.ssi.depot.dao.ISystemLogDAO.selectSystemLogByAll");
	}
	...
	public List<SystemLog> selectSystemLogByPage(Map<String,Integer> map) {
		return getSqlSession().selectList("com.ssi.depot.dao.ISystemLogDAO.selectSystemLogByPage",map);
	}
	...
	public SystemLog selectSystemLogById(String sysid) {
		return (SystemLog) getSqlSession().selectOne("com.ssi.depot.dao.ISystemLogDAO.selectSystemLogById",Integer.valueOf(sysid));
	}
